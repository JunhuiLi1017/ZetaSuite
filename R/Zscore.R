...
#'   \item Applies Z-score transformation: \eqn{Z_{ij} = (X_{ij} - \mu_{j}) / \sigma_{j}}
#'   where \eqn{X_{ij}} is the raw value for gene \eqn{i} in readout \eqn{j}, \eqn{\mu_{j}} is the mean of negative controls in readout \eqn{j}, and \eqn{\sigma_{j}} is the standard deviation of negative controls in readout \eqn{j}
#' }
#' 
